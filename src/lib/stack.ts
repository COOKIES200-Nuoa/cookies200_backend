...
export class QuickSightIntegrationStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    tenantGroups.forEach((tenantName) => {
      ...
      // Add policies for assume tenant role AFTER tenant role definition
      nuoaAuthRole.addToPolicy(
        new iam.PolicyStatement({
          effect: iam.Effect.ALLOW,
          actions: ['sts:AssumeRole'],
          resources: [tenantRole.roleArn], // Use the tenantRole ARN directly
        })
      );
      ...
      roleMappings[
        ...
        RoleARN: tenantRole.roleArn, // Assign the RoleARN here
      };
    });
